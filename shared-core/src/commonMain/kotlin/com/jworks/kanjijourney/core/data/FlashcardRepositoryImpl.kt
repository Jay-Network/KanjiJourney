...
import com.jworks.kanjijourney.core.domain.model.FlashcardDeckGroup
import com.jworks.kanjijourney.core.domain.model.FlashcardEntry
...
internal fun com.jworks.kanjijourney.db.Flashcard_deck.toFlashcardEntry(): FlashcardEntry = FlashcardEntry(
    deckId = deck_id,
...
internal fun com.jworks.kanjijourney.db.Flashcard_deck_group.toDeckGroup(): FlashcardDeckGroup = FlashcardDeckGroup(
    id = id,
    name = name,
