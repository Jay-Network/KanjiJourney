...
import com.jworks.kanjijourney.core.domain.model.parseJsonStringArray
...
internal fun com.jworks.kanjijourney.db.Vocabulary.toVocabulary(): Vocabulary = Vocabulary(
    id = id,
    kanjiForm = kanji_form,
    reading = reading,
    meaningsEn = parseJsonStringArray(meanings_en),
...
internal fun com.jworks.kanjijourney.db.Example_sentence.toExampleSentence(): ExampleSentence = ExampleSentence(
    id = id,
    vocabId = vocab_id,
    japanese = japanese,
    english = english
