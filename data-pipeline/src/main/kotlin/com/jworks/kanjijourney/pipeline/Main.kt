package com.jworks.kanjijourney.pipeline

import com.jworks.kanjijourney.pipeline.parser.Kanjidic2Parser
import com.jworks.kanjijourney.pipeline.parser.KanjiVgParser
import com.jworks.kanjijourney.pipeline.parser.JMDictParser
import com.jworks.kanjijourney.pipeline.parser.KanaDataGenerator
import com.jworks.kanjijourney.pipeline.parser.RadicalParser
import java.io.File
...
fun main(args: Array<String>) {
    ...
    val outputPath = args.getOrNull(1) ?: "android-app/src/main/assets/kanjijourney.db"

    println("KanjiJourney Data Pipeline")
    println("========================")
