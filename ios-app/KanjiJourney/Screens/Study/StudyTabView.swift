            ...
            VStack(alignment: .leading, spacing: 16) {
                        ...
                        ForEach(availableModes, id: \.self) { mode in
                            ...
                            Button(action: {
                                ...
                                .background(
                                    ...
                                    isAccessible ? KanjiJourneyTheme.surfaceVariant :
                                    KanjiJourneyTheme.surfaceVariant.opacity(0.5)
                                )
                                .cornerRadius(12)
                            }
                        }
                    ...
                    HStack(spacing: 8) {
                        ForEach(KanaFilter.allCases, id: \.self) { filter in
                            ...
                            Text(filter.rawValue)
                                ...
                                .padding(.vertical, 8)
                                .background(isSelected ? Color(hex: 0xE91E63) : KanjiJourneyTheme.surfaceVariant)
                                .cornerRadius(8)
                ...
                Button(action: {
                    ...
                    Text("Start Session")
                        ...
                        .frame(height: 56)
                        .background(canStart ? KanjiJourneyTheme.primary : KanjiJourneyTheme.primary.opacity(0.4))
                        .cornerRadius(16)
                }
                .disabled(!canStart)
