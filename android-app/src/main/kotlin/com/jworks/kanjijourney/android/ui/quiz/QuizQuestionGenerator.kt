package com.jworks.kanjijourney.android.ui.quiz

import com.jworks.kanjijourney.core.domain.model.Kana
import com.jworks.kanjijourney.core.domain.model.KanaType
import com.jworks.kanjijourney.core.domain.model.KanaVariant
...
class QuizQuestionGenerator @Inject constructor(
    ...
    suspend fun generateQuestions(scope: TestScope, count: Int = 10): List<QuizQuestion> {
        return when (scope) {
            ...
            TestScope.GRADE_4, TestScope.GRADE_5, TestScope.GRADE_6 -> {
                ...
                generateGradeKanjiJourneyions(grade, count)
            }
            ...
            TestScope.JLPT_N2, TestScope.JLPT_N1 -> {
                ...
                generateJlptKanjiJourneyions(level, count)
            }
        }
    }
    ...
    private suspend fun generateGradeKanjiJourneyions(grade: Int, count: Int): List<QuizQuestion> {
        val gradeKanji = kanjiRepository.getKanjiByGrade(grade)
        return generateKanjiMeaningQuestions(gradeKanji, count)
    }

    private suspend fun generateJlptKanjiJourneyions(level: Int, count: Int): List<QuizQuestion> {
